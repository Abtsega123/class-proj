/* IN this code, the program takes two numbers of input and outputs their difference. NB: it substracts from the smaller number from the greatest and outputs posetive value only.
